    ...
    function printResults()
    {
        ...
        e.html(function() {
            if (results.length == 0)
            {
                e.append('<li style="padding-top: 3px; padding-bottom: 3px"><a word-wrap: break-word; white-space: normal" href="#">No results found</a></li><hr />');
            }
            else
            {
                $.each(results, function(t, n) {
                    e.append('<li style="padding-top: 3px; padding-bottom: 3px"><a word-wrap: break-word; white-space: normal" href="' + n[1] + '">&bull; ' + n[0] + '</a></li><hr />');
                });
            }
        });
    }
